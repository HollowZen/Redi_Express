...
//
//  https://github.com/HollowZen/Redi_Express
            ...
            VStack(alignment: .leading){
                ...
                HStack(alignment: .center)
                {
                    ...
                    HStack{
                        ...
                        Text("By ticking this box, you agree to our ").foregroundColor(.black)
                            +
                        Text("Terms and conditions and private policy").foregroundColor(.yellow)
